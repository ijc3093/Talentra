...
--
-- Host: localhost:8889
-- Generation Time: Jul 24, 2026 at 03:42 PM
...
-- ==============================================================================
-- SCHEMA GROUPS (for readability)
-- ==============================================================================
-- Tables are ordered: ADMIN → ORGANIZATION → PUBLIC USER. Import order is preserved.

-- ==============================================================================
-- GROUP: ADMIN — TABLE STRUCTURE & DATA
-- ==============================================================================
-- Platform admin portal: admins, staff, roles, plans, brands, publisher naming
...
(9, 'Super Admin', 'admin', 'ADM-0000-0000', 'admin@example.com', '$2y$10$nhBcqv9rP9TCPnoYCsfDnOHj2o63MG5rLQzGLbn0VMScMuRvjtBeW', 'N/A', 'N/A', 'Admin', 1, 'default.jpg', NULL, NULL, 1, '2026-07-01 22:49:15', 0, '2026-07-24 03:35:28', 0, NULL, NULL, NULL, 0, NULL, NULL, 67, 68, 20),
...
CREATE TABLE `commerce_brands` (
  ...
  `icon_letter` char(1) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `publisher_name_authority` (
  ...
  `commerce_brand_id` int(10) UNSIGNED DEFAULT NULL,
  `applicant_username` varchar(120) NOT NULL DEFAULT '',
  `applicant_email` varchar(120) NOT NULL DEFAULT '',
...
-- ==============================================================================
-- GROUP: ORGANIZATION — TABLE STRUCTURE & DATA
-- ==============================================================================
-- Seller / enterprise org portal: orgs, members, posts, shop, CRM, payroll
...
CREATE TABLE `organizations` (
  ...
  `commerce_brand_id` int(10) UNSIGNED DEFAULT NULL,
  `seller_plan` enum('individual','professional') NOT NULL DEFAULT 'individual',
...
--
-- Table structure for table `org_cart_items`
--

CREATE TABLE `org_cart_items` (
  `id` bigint(20) NOT NULL,
  `user_id` bigint(20) NOT NULL,
  `org_id` bigint(20) NOT NULL,
...
--
-- Table structure for table `org_crm_bookings`
--

CREATE TABLE `org_crm_bookings` (
  `id` bigint(20) NOT NULL,
  `org_id` bigint(20) NOT NULL,
...
--
-- Table structure for table `org_crm_campaigns`
--

CREATE TABLE `org_crm_campaigns` (
  `id` bigint(20) NOT NULL,
  `org_id` bigint(20) NOT NULL,
...
--
-- Table structure for table `org_crm_contact_addresses`
--

CREATE TABLE `org_crm_contact_addresses` (
  `id` bigint(20) NOT NULL,
  `org_id` bigint(20) NOT NULL,
...
--
-- Table structure for table `org_crm_contact_files`
--

CREATE TABLE `org_crm_contact_files` (
  `id` bigint(20) NOT NULL,
  `org_id` bigint(20) NOT NULL,
  `contact_id` bigint(20) NOT NULL,
...
--
-- Table structure for table `org_crm_contacts`
--

CREATE TABLE `org_crm_contacts` (
  `id` bigint(20) NOT NULL,
  `org_id` bigint(20) NOT NULL,
  ...
  `lead_source` enum('manual','shop','referral','web','portal','phone','import','other') NOT NULL DEFAULT 'manual',
...
--
-- Table structure for table `org_crm_deals`
--

CREATE TABLE `org_crm_deals` (
  `id` bigint(20) NOT NULL,
  `org_id` bigint(20) NOT NULL,
  `contact_id` bigint(20) DEFAULT NULL,
  `title` varchar(200) NOT NULL,
...
--
-- Table structure for table `org_crm_feedback`
--

CREATE TABLE `org_crm_feedback` (
  `id` bigint(20) NOT NULL,
  `org_id` bigint(20) NOT NULL,
  `contact_id` bigint(20) DEFAULT NULL,
...
--
-- Table structure for table `org_crm_interactions`
--

CREATE TABLE `org_crm_interactions` (
  `id` bigint(20) NOT NULL,
  `org_id` bigint(20) NOT NULL,
  `contact_id` bigint(20) NOT NULL,
...
--
-- Table structure for table `org_crm_invoices`
--

CREATE TABLE `org_crm_invoices` (
  `id` bigint(20) NOT NULL,
  `org_id` bigint(20) NOT NULL,
  `contact_id` bigint(20) DEFAULT NULL,
...
--
-- Table structure for table `org_crm_quotes`
--

CREATE TABLE `org_crm_quotes` (
  `id` bigint(20) NOT NULL,
  `org_id` bigint(20) NOT NULL,
  `contact_id` bigint(20) DEFAULT NULL,
...
--
-- Table structure for table `org_crm_reminders`
--

CREATE TABLE `org_crm_reminders` (
  `id` bigint(20) NOT NULL,
  `org_id` bigint(20) NOT NULL,
  `contact_id` bigint(20) DEFAULT NULL,
...
--
-- Table structure for table `org_crm_ticket_replies`
--

CREATE TABLE `org_crm_ticket_replies` (
  `id` bigint(20) NOT NULL,
  `org_id` bigint(20) NOT NULL,
...
--
-- Table structure for table `org_crm_tickets`
--

CREATE TABLE `org_crm_tickets` (
  `id` bigint(20) NOT NULL,
  `org_id` bigint(20) NOT NULL,
  `contact_id` bigint(20) DEFAULT NULL,
...
--
-- Table structure for table `org_employee_details`
--

CREATE TABLE `org_employee_details` (
...
--
-- Table structure for table `org_member_addresses`
--

CREATE TABLE `org_member_addresses` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `org_member_earnings_accounts`
--

CREATE TABLE `org_member_earnings_accounts` (
  `id` int(11) NOT NULL,
  `org_id` int(11) NOT NULL,
  `org_member_id` int(11) NOT NULL,
...
--
-- Table structure for table `org_member_earnings_transactions`
--

CREATE TABLE `org_member_earnings_transactions` (
  `id` int(11) NOT NULL,
  `org_id` int(11) NOT NULL,
  `org_member_id` int(11) NOT NULL,
  `amount_cents` int(11) NOT NULL,
  `balance_after_cents` bigint(20) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `org_order_returns`
--

CREATE TABLE `org_order_returns` (
  `id` bigint(20) NOT NULL,
  `org_id` bigint(20) NOT NULL,
  `order_id` bigint(20) NOT NULL,
...
CREATE TABLE `org_orders` (
  ...
  `product_id` bigint(20) NOT NULL,
  `product_title` varchar(200) NOT NULL,
  `product_unit_code` varchar(40) DEFAULT NULL,
  `unit_price_cents` int(11) NOT NULL DEFAULT '0',
  `currency` varchar(3) NOT NULL DEFAULT 'USD',
  `quantity` int(11) NOT NULL DEFAULT '1',
  `total_cents` int(11) NOT NULL DEFAULT '0',
  ...
  `tax_cents` int(11) NOT NULL DEFAULT '0',
  `service_fee_cents` int(11) NOT NULL DEFAULT '0',
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `buyer_hidden_at` datetime DEFAULT NULL,
  `delivered_at` datetime DEFAULT NULL,
  `fulfillment_method` enum('fba','fbm') NOT NULL DEFAULT 'fbm',
  `delivery_option` enum('pickup','home_delivery','same_day') NOT NULL DEFAULT 'home_delivery',
  `referral_fee_cents` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `org_pay_run_lines`
--

CREATE TABLE `org_pay_run_lines` (
  `id` bigint(20) UNSIGNED NOT NULL,
  ...
  `gross_cents` int(11) NOT NULL DEFAULT '0',
  `deductions_cents` int(11) NOT NULL DEFAULT '0',
  `net_cents` int(11) NOT NULL DEFAULT '0',
  `employer_tax_cents` int(11) NOT NULL DEFAULT '0',
  `deduction_note` varchar(255) DEFAULT NULL,
  `line_note` varchar(255) DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `worked_seconds` int(11) NOT NULL DEFAULT '0',
  `hourly_rate_cents` int(11) NOT NULL DEFAULT '0',
  `regular_cents` int(11) NOT NULL DEFAULT '0',
  `overtime_cents` int(11) NOT NULL DEFAULT '0',
  `bonus_cents` int(11) NOT NULL DEFAULT '0',
  `commission_cents` int(11) NOT NULL DEFAULT '0',
  `holiday_cents` int(11) NOT NULL DEFAULT '0',
  `vacation_cents` int(11) NOT NULL DEFAULT '0',
  `ded_federal_cents` int(11) NOT NULL DEFAULT '0',
  `ded_state_cents` int(11) NOT NULL DEFAULT '0',
  `ded_health_cents` int(11) NOT NULL DEFAULT '0',
  `ded_dental_cents` int(11) NOT NULL DEFAULT '0',
  `ded_retirement_cents` int(11) NOT NULL DEFAULT '0',
  `ded_other_cents` int(11) NOT NULL DEFAULT '0',
  `etax_social_cents` int(11) NOT NULL DEFAULT '0',
  `etax_medicare_cents` int(11) NOT NULL DEFAULT '0',
  `etax_unemp_cents` int(11) NOT NULL DEFAULT '0',
  `etax_workers_cents` int(11) NOT NULL DEFAULT '0',
  `overtime_seconds` int(11) NOT NULL DEFAULT '0',
  `paid_leave_seconds` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
-- --------------------------------------------------------

--
-- Table structure for table `org_pay_runs`
--

CREATE TABLE `org_pay_runs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `org_id` bigint(20) UNSIGNED NOT NULL,
  ...
  `approved_at` datetime DEFAULT NULL,
  `approved_by_member_id` bigint(20) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
-- --------------------------------------------------------

--
-- Table structure for table `org_payroll_profiles`
--

CREATE TABLE `org_payroll_profiles` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `org_id` bigint(20) UNSIGNED NOT NULL,
  `org_member_id` bigint(20) UNSIGNED NOT NULL,
  `pay_type` varchar(20) NOT NULL DEFAULT 'salary',
  `default_gross_cents` int(11) NOT NULL DEFAULT '0',
  `default_deductions_cents` int(11) NOT NULL DEFAULT '0',
  `default_employer_tax_cents` int(11) NOT NULL DEFAULT '0',
  `notes` varchar(500) DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `pay_frequency` varchar(20) NOT NULL DEFAULT 'monthly',
  `hourly_rate_cents` int(11) NOT NULL DEFAULT '0',
  `annual_salary_cents` bigint(20) NOT NULL DEFAULT '0',
  `tax_status` varchar(20) NOT NULL DEFAULT 'single',
  `bank_name` varchar(120) NOT NULL DEFAULT '',
  `overtime_eligible` tinyint(4) NOT NULL DEFAULT '1',
  `expected_weekly_hours` decimal(6,2) NOT NULL DEFAULT '40.00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
-- --------------------------------------------------------
...
--
-- Table structure for table `org_product_reviews`
--

CREATE TABLE `org_product_reviews` (
  `id` bigint(20) NOT NULL,
  `org_id` bigint(20) NOT NULL,
  `product_id` bigint(20) NOT NULL,
...
CREATE TABLE `org_products` (
  ...
  `delivery_carriers` varchar(255) DEFAULT NULL,
  `shipping_fee_cents` int(11) NOT NULL DEFAULT '0',
  ...
  `selling_type` varchar(80) DEFAULT NULL,
...
--
-- Table structure for table `org_time_cards`
--

CREATE TABLE `org_time_cards` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `org_id` bigint(20) UNSIGNED NOT NULL,
  `org_member_id` bigint(20) UNSIGNED NOT NULL,
  `employee_name` varchar(190) NOT NULL DEFAULT '',
  ...
  `approved_at` datetime DEFAULT NULL,
  `approved_by_member_id` bigint(20) UNSIGNED DEFAULT NULL,
  `pay_run_id` bigint(20) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
-- --------------------------------------------------------

-- ==============================================================================
-- GROUP: PUBLIC USER — TABLE STRUCTURE & DATA
-- ==============================================================================
-- Buyer / personal app: users, feed, chat, lives, capsules, commerce buyer side
...
CREATE TABLE `user_profile_settings` (
  ...
  `theme_auto_enabled` tinyint(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Dumping data for table `public_post_saves`
--
...
INSERT INTO `buyer_shipping_addresses` (`id`, `user_id`, `label`, `full_name`, `phone`, `line1`, `line2`, `city`, `region`, `postal_code`, `country`, `is_default`, `created_at`, `updated_at`) VALUES
(1, 75, 'Home', 'Maka Ori', '7580094578', '210 Apollo RD', 'House', 'Garland, TX', '75040', NULL, 'US', 1, '2026-07-14 18:11:33', '2026-07-20 11:09:11'),
(2, 74, 'Home', 'John K', '7893457890', '210 Apollo RD', NULL, 'Garland, TX', '75040', NULL, 'US', 1, '2026-07-15 15:27:51', '2026-07-20 11:14:11');

-- --------------------------------------------------------

--
-- Table structure for table `buyer_memberships`
--
...
--
-- Table structure for table `buyer_membership_payments`
--

CREATE TABLE `buyer_membership_payments` (
  `id` bigint(20) NOT NULL,
  `user_id` bigint(20) NOT NULL,
  `amount_cents` int(11) NOT NULL DEFAULT '0',
  `currency` varchar(3) NOT NULL DEFAULT 'USD',
...
--
-- Table structure for table `buyer_seller_relationships`
--

CREATE TABLE `buyer_seller_relationships` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
-- ==============================================================================
-- Primary keys and indexes, still grouped by Admin / Organization / Public User
...
ALTER TABLE `platform_payments`
  ...
  ADD KEY `fk_platform_payments_admin` (`recorded_by_admin_id`);

--
-- Indexes for table `commerce_brands`
--
ALTER TABLE `commerce_brands`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_commerce_brands_slug` (`slug`),
  ADD KEY `idx_commerce_brands_active_sort` (`is_active`,`sort_order`,`name`);
...
ALTER TABLE `publisher_name_authority`
  ...
  ADD KEY `idx_pna_commerce_brand_email` (`commerce_brand_id`,`applicant_email`,`status`);
...
--
-- Indexes for table `org_cart_items`
--
ALTER TABLE `org_cart_items`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_cart_user_product` (`user_id`,`product_id`),
  ADD KEY `idx_cart_user` (`user_id`,`updated_at`);

--
-- Indexes for table `org_crm_bookings`
--
ALTER TABLE `org_crm_bookings`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_crm_bookings_org_sched` (`org_id`,`status`,`scheduled_at`),
  ADD KEY `idx_crm_bookings_contact` (`contact_id`),
  ADD KEY `idx_crm_bookings_fieldworker` (`fieldworker_member_id`);

--
-- Indexes for table `org_crm_campaigns`
--
ALTER TABLE `org_crm_campaigns`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_crm_campaigns_org` (`org_id`,`status`,`scheduled_at`);

--
-- Indexes for table `org_crm_contact_addresses`
--
ALTER TABLE `org_crm_contact_addresses`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_crm_addresses_contact` (`contact_id`);

--
-- Indexes for table `org_crm_contact_files`
--
ALTER TABLE `org_crm_contact_files`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_crm_files_contact` (`contact_id`,`created_at`);

--
-- Indexes for table `org_crm_contacts`
--
ALTER TABLE `org_crm_contacts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_crm_contacts_org_stage` (`org_id`,`lifecycle_stage`,`updated_at`),
  ADD KEY `idx_crm_contacts_org_email` (`org_id`,`email`),
  ADD KEY `idx_crm_contacts_linked_user` (`linked_user_id`);

--
-- Indexes for table `org_crm_deals`
--
ALTER TABLE `org_crm_deals`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_crm_deals_org_stage` (`org_id`,`stage`,`expected_close_date`),
  ADD KEY `idx_crm_deals_contact` (`contact_id`);

--
-- Indexes for table `org_crm_feedback`
--
ALTER TABLE `org_crm_feedback`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_crm_feedback_org` (`org_id`,`created_at`),
  ADD KEY `idx_crm_feedback_contact` (`contact_id`);

--
-- Indexes for table `org_crm_interactions`
--
ALTER TABLE `org_crm_interactions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_crm_interactions_contact` (`contact_id`,`created_at`),
  ADD KEY `idx_crm_interactions_org` (`org_id`,`created_at`);

--
-- Indexes for table `org_crm_invoices`
--
ALTER TABLE `org_crm_invoices`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_crm_invoice_code` (`invoice_code`),
  ADD KEY `idx_crm_invoices_org_status` (`org_id`,`status`,`due_date`),
  ADD KEY `idx_crm_invoices_contact` (`contact_id`);

--
-- Indexes for table `org_crm_quotes`
--
ALTER TABLE `org_crm_quotes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_crm_quote_code` (`quote_code`),
  ADD KEY `idx_crm_quotes_org_status` (`org_id`,`status`,`created_at`),
  ADD KEY `idx_crm_quotes_contact` (`contact_id`);

--
-- Indexes for table `org_crm_reminders`
--
ALTER TABLE `org_crm_reminders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_crm_reminders_org_due` (`org_id`,`status`,`due_at`),
  ADD KEY `idx_crm_reminders_contact` (`contact_id`);

--
-- Indexes for table `org_crm_ticket_replies`
--
ALTER TABLE `org_crm_ticket_replies`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_crm_ticket_replies_ticket` (`ticket_id`,`created_at`);

--
-- Indexes for table `org_crm_tickets`
--
ALTER TABLE `org_crm_tickets`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_crm_ticket_code` (`ticket_code`),
  ADD KEY `idx_crm_tickets_org_status` (`org_id`,`status`,`updated_at`),
  ADD KEY `idx_crm_tickets_contact` (`contact_id`);

--
-- Indexes for table `org_employee_details`
--
ALTER TABLE `org_employee_details`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_org_employee_detail_member` (`org_id`,`org_member_id`),
  ADD KEY `idx_org_employee_details_org` (`org_id`);
...
--
-- Indexes for table `org_member_addresses`
--
ALTER TABLE `org_member_addresses`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_org_member_addr` (`org_id`,`org_member_id`);

--
-- Indexes for table `org_member_earnings_accounts`
--
ALTER TABLE `org_member_earnings_accounts`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_org_member_earn_acct` (`org_id`,`org_member_id`);

--
-- Indexes for table `org_member_earnings_transactions`
--
ALTER TABLE `org_member_earnings_transactions`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_earn_txn_idempotent` (`org_id`,`reference_type`,`reference_id`,`txn_type`),
  ADD KEY `idx_earn_txn_member` (`org_id`,`org_member_id`,`created_at`);
...
--
-- Indexes for table `org_order_returns`
--
ALTER TABLE `org_order_returns`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_returns_order` (`order_id`),
  ADD KEY `idx_returns_buyer` (`buyer_user_id`,`created_at`);
...
ALTER TABLE `org_orders`
  ...
  ADD UNIQUE KEY `uq_org_orders_product_unit_code` (`product_unit_code`),
  ...
  ADD KEY `idx_org_orders_promo` (`org_id`,`promo_code`),
  ADD KEY `idx_org_orders_buyer_hidden` (`buyer_user_id`,`buyer_hidden_at`,`created_at`);

--
-- Indexes for table `org_pay_run_lines`
--
ALTER TABLE `org_pay_run_lines`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_org_pay_run_line_member` (`pay_run_id`,`org_member_id`),
  ADD KEY `idx_org_pay_run_lines_run` (`pay_run_id`),
  ADD KEY `idx_org_pay_run_lines_org` (`org_id`);

--
-- Indexes for table `org_pay_runs`
--
ALTER TABLE `org_pay_runs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_org_pay_runs_org_status` (`org_id`,`status`),
  ADD KEY `idx_org_pay_runs_period` (`org_id`,`period_start`,`period_end`);

--
-- Indexes for table `org_payroll_profiles`
--
ALTER TABLE `org_payroll_profiles`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_org_payroll_profile_member` (`org_id`,`org_member_id`),
  ADD KEY `idx_org_payroll_profiles_org` (`org_id`);
...
--
-- Indexes for table `org_product_reviews`
--
ALTER TABLE `org_product_reviews`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_review_order_buyer` (`order_id`,`buyer_user_id`),
  ADD KEY `idx_reviews_product` (`product_id`,`created_at`),
  ADD KEY `idx_reviews_org` (`org_id`,`created_at`);
...
ALTER TABLE `org_products`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_org_products_code` (`org_id`,`product_code`),
  ADD UNIQUE KEY `uq_org_products_product_code` (`product_code`),
  ...
  ADD KEY `idx_org_products_slug` (`org_id`,`slug`);
...
--
-- Indexes for table `org_time_cards`
--
ALTER TABLE `org_time_cards`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_org_time_cards_member` (`org_id`,`org_member_id`),
  ADD KEY `idx_org_time_cards_open` (`org_id`,`org_member_id`,`clock_out`);
...
ALTER TABLE `buyer_shipping_addresses`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_buyer_addr_user` (`user_id`,`is_default`,`updated_at`);

--
-- Indexes for table `buyer_memberships`
--
ALTER TABLE `buyer_memberships`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_buyer_memberships_user` (`user_id`),
  ADD KEY `idx_buyer_memberships_status` (`status`,`paid_until`);

--
-- Indexes for table `buyer_membership_payments`
--
ALTER TABLE `buyer_membership_payments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_buyer_membership_payments_user` (`user_id`,`paid_at`),
  ADD KEY `idx_buyer_membership_payments_ref` (`payment_reference`);

--
-- Indexes for table `buyer_seller_relationships`
--
ALTER TABLE `buyer_seller_relationships`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_buyer_seller_rel` (`buyer_user_id`,`org_id`),
  ADD KEY `idx_buyer_seller_rel_org` (`org_id`,`updated_at`),
  ADD KEY `idx_buyer_seller_rel_buyer` (`buyer_user_id`,`updated_at`);
...
-- ==============================================================================
-- Grouped by Admin / Organization / Public User
...
--
ALTER TABLE `feedback_admin`
  MODIFY `id_feedback_admin` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `commerce_brands`
--
ALTER TABLE `commerce_brands`
...
--
-- AUTO_INCREMENT for table `org_cart_items`
--
ALTER TABLE `org_cart_items`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `org_crm_bookings`
--
ALTER TABLE `org_crm_bookings`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `org_crm_campaigns`
--
ALTER TABLE `org_crm_campaigns`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `org_crm_contact_addresses`
--
ALTER TABLE `org_crm_contact_addresses`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `org_crm_contact_files`
--
ALTER TABLE `org_crm_contact_files`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `org_crm_contacts`
--
ALTER TABLE `org_crm_contacts`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `org_crm_deals`
--
ALTER TABLE `org_crm_deals`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `org_crm_feedback`
--
ALTER TABLE `org_crm_feedback`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `org_crm_interactions`
--
ALTER TABLE `org_crm_interactions`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `org_crm_invoices`
--
ALTER TABLE `org_crm_invoices`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `org_crm_quotes`
--
ALTER TABLE `org_crm_quotes`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `org_crm_reminders`
--
ALTER TABLE `org_crm_reminders`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `org_crm_ticket_replies`
--
ALTER TABLE `org_crm_ticket_replies`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `org_crm_tickets`
--
ALTER TABLE `org_crm_tickets`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `org_employee_details`
--
ALTER TABLE `org_employee_details`
...
--
-- AUTO_INCREMENT for table `org_member_addresses`
--
ALTER TABLE `org_member_addresses`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `org_member_earnings_accounts`
--
ALTER TABLE `org_member_earnings_accounts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `org_member_earnings_transactions`
--
ALTER TABLE `org_member_earnings_transactions`
...
--
-- AUTO_INCREMENT for table `org_order_returns`
--
ALTER TABLE `org_order_returns`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `org_pay_run_lines`
--
ALTER TABLE `org_pay_run_lines`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `org_pay_runs`
--
ALTER TABLE `org_pay_runs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `org_payroll_profiles`
--
ALTER TABLE `org_payroll_profiles`
...
--
-- AUTO_INCREMENT for table `org_product_reviews`
--
ALTER TABLE `org_product_reviews`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `org_time_cards`
--
ALTER TABLE `org_time_cards`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

-- ------------------------------------------------------------------------------
-- AUTO_INCREMENT — PUBLIC USER
-- ------------------------------------------------------------------------------
...
--
ALTER TABLE `user_sessions`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=399621;
...
--
-- AUTO_INCREMENT for table `buyer_memberships`
--
ALTER TABLE `buyer_memberships`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `buyer_membership_payments`
--
ALTER TABLE `buyer_membership_payments`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `buyer_seller_relationships`
--
ALTER TABLE `buyer_seller_relationships`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `user_video_live_signals`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4564;

--
-- AUTO_INCREMENT for table `user_video_live_viewers`
--
ALTER TABLE `user_video_live_viewers`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16290;

-- ==============================================================================
-- CONSTRAINTS FOR DUMPED TABLES
-- ==============================================================================
-- Foreign keys, grouped by Admin / Organization / Public User
...
ALTER TABLE `platform_payments`
  ...
  ADD CONSTRAINT `fk_platform_payments_plan` FOREIGN KEY (`plan_id`) REFERENCES `platform_plans` (`id`) ON DELETE NO ACTION;
...
ALTER TABLE `org_orders`
  ...
  ADD CONSTRAINT `fk_org_orders_product` FOREIGN KEY (`product_id`) REFERENCES `org_products` (`id`) ON DELETE NO ACTION,
...
ALTER TABLE `org_subscriptions`
  ...
  ADD CONSTRAINT `fk_org_subscriptions_product` FOREIGN KEY (`product_id`) REFERENCES `org_products` (`id`) ON DELETE NO ACTION;

-- ------------------------------------------------------------------------------
-- Constraints — PUBLIC USER
-- ------------------------------------------------------------------------------
