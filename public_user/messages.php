...
<head>
  ...
  <style>
    ...
    .peerAvatar img{width:100%;height:100%;min-width:100%;min-height:100%;max-width:100%;max-height:100%;object-fit:cover;object-position:center;border-radius:50%;display:block;}
    .peerAvatar{
    ...
    .bubble{
      ...
      padding:10px 12px;
      border-radius:16px;
      background:var(--msb-palette-bubble-bg, #ebeef2);
      border:1px solid var(--msb-palette-bubble-border, rgba(118, 152, 226, 0.1));
      box-shadow:none;
      overflow-wrap:anywhere;
      word-break:break-word;
      color:var(--msb-palette-bubble-text, #202124);
    }
    .bubble.me{
      background:linear-gradient(135deg,var(--brand),var(--brand2));
      color:#fff;
...
<style>
  ...
  .messages-shell-tab.active{
    background:var(--msg-accent-soft, var(--msb-palette-action-soft, rgba(99,91,255,.12)));
    color:var(--msg-accent, var(--msb-palette-action, #635bff));
    box-shadow:none;
  }
  .messages-shell-search{
    ...
    min-height:42px;
    border-radius:999px;
    background:var(--msg-panel-3, var(--msb-palette-hover-bg, #f5f5f5));
    padding:0 18px;
    color:var(--msg-muted);
  }
  ...
  .messages-shell-avatar{
    ...
    height:40px;
    border-radius:999px;
    background:var(--msb-palette-nav-hover, #f6f6f6);
    display:inline-flex;
    align-items:center;
    justify-content:center;
    color:var(--msb-palette-icon, #202124);
    flex:0 0 auto;
  }
  ...
  .group-form-grid input[type="text"]:focus{
    border-color:var(--msb-palette-action, rgba(99,91,255,.42));
    box-shadow:0 0 0 4px var(--msb-palette-action-soft, rgba(99,91,255,.10));
  }
  .group-member-picker{
    display:grid;
    gap:10px;
  ...
  .chat-search-wrap{
    ...
    align-items:center;
    gap:12px;
    background:var(--msg-panel-3, var(--msb-palette-hover-bg, #f7f7f7));
    border-radius:12px;
    padding:0 16px;
    height:48px;
    color:var(--msg-muted);
  ...
  .chat-empty-plus{
    ...
    color:var(--msb-palette-action, #ffffff) !important;
    box-shadow:none;
    font-size:24px;
  ...
  .chat-empty-plus:hover{
    color:var(--msb-palette-action, #ffffff) !important;
    background:var(--msb-palette-action-soft, var(--msb-palette-nav-hover, #6d66ff)) !important;
  ...
  .iconbar i{
    color:var(--msb-palette-icon, #635bff) !important;
    background:transparent !important;
  ...
  .iconbar .chat-info-toggle.is-active i{
    color:var(--msb-palette-action, #3f38d8) !important;
  }
  ...
  .bubble{
    ...
    width:auto;
    min-width:64px;
    border:1px solid var(--msb-palette-bubble-border, transparent) !important;
    border-radius:12px !important;
    background:var(--msb-palette-bubble-bg, #f5f5f5) !important;
    box-shadow:none !important;
    padding:10px 14px !important;
    color:var(--msb-palette-bubble-text, #202124) !important;
    order:1;
    visibility:visible !important;
    opacity:1 !important;
  }
  ...
  .group-send-form button[type="submit"]{
    ...
    background:transparent !important;
    box-shadow:none !important;
    color:var(--msb-palette-icon, #202124) !important;
    font-size:17px;
    padding:0 !important;
  }
  .group-send-form button[type="submit"]{
  ...
  #videoCallOverlay{
    ...
    z-index:1000000;
    padding:12px;
    background:var(--msb-palette-bg, linear-gradient(180deg, rgba(10,14,24,.96), rgba(7,10,18,.98)));
  ...
  .vcall-shell{
    ...
    /* border-radius:28px; */
    overflow:hidden;
    border:1px solid var(--msb-palette-border, rgba(255,255,255,.08));
    background:var(--msb-palette-bg, #0b1626);
    box-shadow:0 28px 90px rgba(0,0,0,.42);
  }
  .vcall-shell.voice-mode .vcall-stage{
    background:var(--msb-palette-bg, linear-gradient(180deg, rgba(31,33,37,.98), rgba(12,14,18,.98)));
  }
  ...
  .vcall-header{
    ...
    gap:18px;
    padding:16px 18px;
    background:var(--msb-palette-bg, #0a1930);
    border-bottom:1px solid var(--msb-palette-border, rgba(255,255,255,.06));
  }
  .vcall-meeting{
    display:flex;
    align-items:center;
  ...
  .vcall-stage-wrap{
    ...
    min-width:0;
    padding:12px;
    background:var(--msb-palette-hover-bg, #6d7c91);
  }
  .vcall-stage{
    position:relative;
    height:100%;
    ...
    border-radius:20px;
    overflow:hidden;
    background:var(--msb-palette-bg, linear-gradient(180deg, rgba(8,14,24,.88), rgba(6,10,18,.98)));
    border:1px solid var(--msb-palette-border, rgba(255,255,255,.08));
  ...
  .vcall-shell.group-mode.pinned-host-layout .vcall-remote-grid[data-primary-count="3"] .vcall-primary-2{
    grid-column:3 / span 2;
    grid-row:1;
  }
  .vcall-shell.group-mode.pinned-host-layout .vcall-remote-grid[data-primary-count="3"] .vcall-primary-3{
  ...
  .vcall-shell.group-mode .vcall-local-tile.has-video .vcall-remote-card{
    z-index:2;
    pointer-events:none;
  }
  ...
  .vcall-shell.group-mode.pinned-host-layout .vcall-remote-grid[data-primary-count="1"] .vcall-primary-tile{
    width:100%;
    height:100%;
    max-width:none;
    aspect-ratio:auto;
  ...
  .vcall-shell.group-mode.pinned-host-layout .vcall-remote-grid[data-primary-count="1"] .vcall-primary-tile video,
  .vcall-shell.group-mode.pinned-host-layout .vcall-remote-grid[data-primary-count="1"] .vcall-primary-tile .vcall-remote-snapshot{
    object-fit:cover;
  }
  .vcall-shell.group-mode.pinned-host-layout .vcall-remote-grid[data-primary-count="1"] .vcall-host-tile{
    width:min(30vw, 260px);
    min-width:180px;
    aspect-ratio:16 / 9;
  }
  .vcall-shell.group-mode.solo-primary-layout .vcall-remote-grid{
    display:block;
    padding:0;
    overflow:visible;
  }
  .vcall-shell.group-mode.solo-primary-layout .vcall-primary-tile{
    position:absolute;
    inset:0;
    width:100% !important;
    max-width:none !important;
  ...
  .vcall-shell.group-mode.solo-primary-layout .vcall-primary-tile video,
  .vcall-shell.group-mode.solo-primary-layout .vcall-primary-tile .vcall-remote-snapshot{
    object-fit:cover;
  }
  .vcall-shell.group-mode.solo-primary-layout .vcall-host-tile{
    position:absolute;
    right:24px;
    bottom:24px;
  ...
  .vcall-shell.group-mode.split-primary-layout .vcall-remote-grid{
    display:grid;
    grid-template-columns:repeat(2, minmax(0, 1fr));
    grid-template-rows:minmax(0, 1fr);
    gap:14px;
  ...
  .vcall-shell.group-mode.split-primary-layout .vcall-remote-grid[data-primary-count="2"]{
    grid-template-columns:repeat(2, minmax(0, 1fr));
    grid-template-rows:minmax(0, 1fr);
  }
  .vcall-shell.group-mode.split-primary-layout .vcall-primary-tile{
    width:100% !important;
    max-width:none !important;
    height:100% !important;
    min-height:0 !important;
  ...
  .vcall-shell.group-mode.split-primary-layout .vcall-primary-tile video,
  .vcall-shell.group-mode.split-primary-layout .vcall-primary-tile .vcall-remote-snapshot{
    object-fit:cover;
  }
  .vcall-shell.group-mode.split-primary-layout .vcall-host-tile{
    position:absolute;
    right:-88px;
    bottom:-72px;
  ...
  .vcall-shell.group-mode.triple-primary-layout .vcall-remote-grid{
    display:grid;
    grid-template-columns:repeat(4, minmax(0, 1fr));
    grid-template-rows:repeat(2, minmax(0, 1fr));
    gap:14px;
  ...
  .vcall-shell.group-mode.triple-primary-layout .vcall-primary-tile{
    width:100% !important;
    max-width:none !important;
    height:100% !important;
    min-height:0 !important;
  ...
  .vcall-shell.group-mode.triple-primary-layout .vcall-remote-grid[data-primary-count="3"] .vcall-primary-1{
    grid-column:1 / span 2 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.triple-primary-layout .vcall-remote-grid[data-primary-count="3"] .vcall-primary-2{
    grid-column:3 / span 2 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.triple-primary-layout .vcall-remote-grid[data-primary-count="3"] .vcall-primary-3{
    grid-column:2 / span 2 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.triple-primary-layout .vcall-primary-tile video,
  .vcall-shell.group-mode.triple-primary-layout .vcall-primary-tile .vcall-remote-snapshot{
    object-fit:cover;
  }
  .vcall-shell.group-mode.triple-primary-layout .vcall-host-tile{
    position:absolute;
    right:18px;
    bottom:-72px;
  ...
  .vcall-shell.group-mode.quad-primary-layout .vcall-remote-grid{
    display:grid;
    grid-template-columns:repeat(3, minmax(0, 1fr));
    grid-template-rows:repeat(2, minmax(0, 1fr));
    gap:14px;
  ...
  .vcall-shell.group-mode.quad-primary-layout .vcall-primary-1{
    grid-column:1;
    grid-row:1;
  }
  .vcall-shell.group-mode.quad-primary-layout .vcall-primary-2{
    grid-column:2;
    grid-row:1;
  }
  .vcall-shell.group-mode.quad-primary-layout .vcall-primary-3{
    grid-column:3;
    grid-row:1;
  }
  .vcall-shell.group-mode.quad-primary-layout .vcall-primary-4{
    grid-column:1;
    grid-row:2;
  }
  .vcall-shell.group-mode.quad-primary-layout .vcall-primary-tile{
    width:100% !important;
    max-width:none !important;
    height:100% !important;
    min-height:0 !important;
  ...
  .vcall-shell.group-mode.quad-primary-layout .vcall-primary-tile video,
  .vcall-shell.group-mode.quad-primary-layout .vcall-primary-tile .vcall-remote-snapshot{
    object-fit:cover;
  }
  .vcall-shell.group-mode.quad-primary-layout .vcall-host-tile{
    position:absolute;
    right:0;
    bottom:0;
  ...
  .vcall-shell.group-mode.quint-primary-layout .vcall-remote-grid{
    display:grid;
    grid-template-columns:repeat(3, minmax(0, 1fr));
    grid-template-rows:repeat(2, minmax(0, 1fr));
    gap:14px;
  ...
  .vcall-shell.group-mode.quint-primary-layout .vcall-primary-1{
    grid-column:1;
    grid-row:1;
  }
  .vcall-shell.group-mode.quint-primary-layout .vcall-primary-2{
    grid-column:2;
    grid-row:1;
  }
  .vcall-shell.group-mode.quint-primary-layout .vcall-primary-3{
    grid-column:3;
    grid-row:1;
  }
  .vcall-shell.group-mode.quint-primary-layout .vcall-primary-4{
    grid-column:1;
    grid-row:2;
  }
  .vcall-shell.group-mode.quint-primary-layout .vcall-primary-5{
    grid-column:2;
    grid-row:2;
  }
  .vcall-shell.group-mode.quint-primary-layout .vcall-primary-tile{
    width:100% !important;
    max-width:none !important;
    height:100% !important;
    min-height:0 !important;
  ...
  .vcall-shell.group-mode.quint-primary-layout .vcall-primary-tile video,
  .vcall-shell.group-mode.quint-primary-layout .vcall-primary-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.quint-primary-layout .vcall-host-tile video,
  .vcall-shell.group-mode.quint-primary-layout .vcall-host-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.quint-primary-layout .vcall-local-tile .vcall-local{
    object-fit:cover;
    background:transparent;
  }
  .vcall-shell.group-mode.quint-primary-layout .vcall-host-tile{
    position:absolute;
    right:0;
    bottom:0;
    width:calc((100% - 28px) / 3) !important;
  ...
  .vcall-shell.group-mode.sext-primary-layout .vcall-remote-grid{
    display:grid;
    grid-template-columns:repeat(3, minmax(0, 1fr));
  ...
  .vcall-shell.group-mode.sext-primary-layout .vcall-primary-tile{
    width:100% !important;
    max-width:none !important;
    height:auto !important;
    min-height:0 !important;
  ...
  .vcall-shell.group-mode.sext-primary-layout .vcall-remote-tile{
    background:transparent !important;
  }
  .vcall-shell.group-mode.sext-primary-layout .vcall-primary-tile video,
  .vcall-shell.group-mode.sext-primary-layout .vcall-primary-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.sext-primary-layout .vcall-host-tile video,
  .vcall-shell.group-mode.sext-primary-layout .vcall-host-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.sext-primary-layout .vcall-local-tile .vcall-local{
  ...
  .vcall-shell.group-mode.sext-primary-layout .vcall-remote-tile.has-video .vcall-remote-card{
    background:transparent !important;
  }
  .vcall-shell.group-mode.sext-primary-layout .vcall-remote-tile.has-video .vcall-remote-card::before,
  .vcall-shell.group-mode.sext-primary-layout .vcall-remote-tile.has-video .vcall-remote-card::after{
    content:none !important;
  }
  .vcall-shell.group-mode.sext-primary-layout .vcall-host-tile{
    position:absolute;
    right:-74px;
    bottom:-72px;
  ...
  .vcall-shell.group-mode.pinned-host-layout .vcall-remote-grid[data-primary-count="3"] .vcall-primary-tile video,
  .vcall-shell.group-mode.pinned-host-layout .vcall-remote-grid[data-primary-count="3"] .vcall-primary-tile .vcall-remote-snapshot{
    object-fit:cover;
  }
  ...
  .vcall-remote-card{
    ...
    padding:18px;
    text-align:center;
    background:var(--msb-palette-bg, linear-gradient(180deg, rgba(11,22,38,.96), rgba(7,13,24,.98)));
  }
  .vcall-remote-avatar{
    width:72px;
    height:72px;
  ...
  .vcall-shell.group-mode.sext-primary-layout .vcall-remote-tile.has-video .vcall-remote-name{
  ...
  .vcall-shell.group-mode.sept-primary-layout .vcall-remote-grid{
    inset:0 0 112px 0 !important;
    display:grid !important;
  ...
  .vcall-shell.group-mode.sept-primary-layout .vcall-primary-tile{
    width:100% !important;
    max-width:none !important;
    height:100% !important;
    min-height:0 !important;
  ...
  .vcall-shell.group-mode.sept-primary-layout .vcall-primary-tile video,
  .vcall-shell.group-mode.sept-primary-layout .vcall-primary-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.sept-primary-layout .vcall-host-tile video,
  .vcall-shell.group-mode.sept-primary-layout .vcall-host-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.sept-primary-layout .vcall-local-tile .vcall-local{
    position:absolute !important;
    inset:0 !important;
    width:100% !important;
    max-width:none !important;
  ...
  .vcall-shell.group-mode.sept-primary-layout .vcall-remote-tile.has-video .vcall-remote-card{
    background:transparent !important;
    opacity:1 !important;
    pointer-events:none !important;
    justify-content:flex-end !important;
  ...
  .vcall-shell.group-mode.sept-primary-layout .vcall-remote-tile.has-video .vcall-remote-name{
    background:rgba(0,0,0,.55) !important;
  }
  .vcall-shell.group-mode.sept-primary-layout .vcall-host-tile{
    right:0 !important;
    bottom:-150px !important;
  ...
  .vcall-shell.group-mode.host-layout.sept-primary-layout .vcall-remote-grid[data-primary-count="7"]{
    grid-template-columns:repeat(4, minmax(0, 1fr)) !important;
    grid-template-rows:repeat(2, minmax(0, 1fr)) !important;
    grid-auto-rows:minmax(0, 1fr) !important;
    grid-auto-flow:row !important;
  }
  .vcall-shell.group-mode.host-layout.sept-primary-layout .vcall-remote-grid[data-primary-count="7"] .vcall-primary-1{
    grid-column:1 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.sept-primary-layout .vcall-remote-grid[data-primary-count="7"] .vcall-primary-2{
    grid-column:2 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.sept-primary-layout .vcall-remote-grid[data-primary-count="7"] .vcall-primary-3{
    grid-column:3 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.sept-primary-layout .vcall-remote-grid[data-primary-count="7"] .vcall-primary-4{
    grid-column:4 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.sept-primary-layout .vcall-remote-grid[data-primary-count="7"] .vcall-primary-5{
    grid-column:1 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.host-layout.sept-primary-layout .vcall-remote-grid[data-primary-count="7"] .vcall-primary-6{
    grid-column:2 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.host-layout.sept-primary-layout .vcall-remote-grid[data-primary-count="7"] .vcall-primary-7{
    grid-column:3 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.oct-primary-layout .vcall-remote-grid{
    inset:0 0 112px 0 !important;
    display:grid !important;
    grid-template-columns:repeat(4, minmax(0, 1fr)) !important;
    grid-template-rows:repeat(2, minmax(0, 1fr)) !important;
  ...
  .vcall-shell.group-mode.oct-primary-layout .vcall-primary-tile{
    width:100% !important;
    max-width:none !important;
    height:100% !important;
    min-height:0 !important;
  ...
  .vcall-shell.group-mode.oct-primary-layout .vcall-primary-tile video,
  .vcall-shell.group-mode.oct-primary-layout .vcall-primary-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.oct-primary-layout .vcall-host-tile video,
  .vcall-shell.group-mode.oct-primary-layout .vcall-host-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.oct-primary-layout .vcall-local-tile .vcall-local{
    position:absolute !important;
    inset:0 !important;
    width:100% !important;
    max-width:none !important;
  ...
  .vcall-shell.group-mode.oct-primary-layout .vcall-remote-tile.has-video .vcall-remote-card{
    background:transparent !important;
    opacity:1 !important;
    pointer-events:none !important;
    justify-content:flex-end !important;
  ...
  .vcall-shell.group-mode.oct-primary-layout .vcall-remote-tile.has-video .vcall-remote-name{
    background:rgba(0,0,0,.55) !important;
  }
  .vcall-shell.group-mode.oct-primary-layout .vcall-host-tile{
    right:0 !important;
    bottom:-150px !important;
    width:min(18vw, 300px) !important;
    min-width:200px !important;
  ...
  .vcall-shell.group-mode.host-layout.oct-primary-layout .vcall-remote-grid[data-primary-count="8"]{
    grid-template-columns:repeat(4, minmax(0, 1fr)) !important;
    grid-template-rows:repeat(2, minmax(0, 1fr)) !important;
    grid-auto-rows:minmax(0, 1fr) !important;
    grid-auto-flow:row !important;
  }
  .vcall-shell.group-mode.host-layout.oct-primary-layout .vcall-remote-grid[data-primary-count="8"] .vcall-primary-1{
    grid-column:1 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.oct-primary-layout .vcall-remote-grid[data-primary-count="8"] .vcall-primary-2{
    grid-column:2 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.oct-primary-layout .vcall-remote-grid[data-primary-count="8"] .vcall-primary-3{
    grid-column:3 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.oct-primary-layout .vcall-remote-grid[data-primary-count="8"] .vcall-primary-4{
    grid-column:4 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.oct-primary-layout .vcall-remote-grid[data-primary-count="8"] .vcall-primary-5{
    grid-column:1 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.host-layout.oct-primary-layout .vcall-remote-grid[data-primary-count="8"] .vcall-primary-6{
    grid-column:2 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.host-layout.oct-primary-layout .vcall-remote-grid[data-primary-count="8"] .vcall-primary-7{
    grid-column:3 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.host-layout.oct-primary-layout .vcall-remote-grid[data-primary-count="8"] .vcall-primary-8{
    grid-column:4 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.nona-primary-layout .vcall-remote-grid{
    inset:0 0 112px 0 !important;
    display:grid !important;
  ...
  .vcall-shell.group-mode.nona-primary-layout .vcall-primary-tile{
    width:100% !important;
    max-width:none !important;
    height:100% !important;
    min-height:0 !important;
  ...
  .vcall-shell.group-mode.nona-primary-layout .vcall-primary-tile video,
  .vcall-shell.group-mode.nona-primary-layout .vcall-primary-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.nona-primary-layout .vcall-host-tile video,
  .vcall-shell.group-mode.nona-primary-layout .vcall-host-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.nona-primary-layout .vcall-local-tile .vcall-local{
    position:absolute !important;
    inset:0 !important;
    width:100% !important;
    max-width:none !important;
  ...
  .vcall-shell.group-mode.nona-primary-layout .vcall-remote-tile.has-video .vcall-remote-card{
    background:transparent !important;
    opacity:1 !important;
    pointer-events:none !important;
    justify-content:flex-end !important;
  ...
  .vcall-shell.group-mode.nona-primary-layout .vcall-remote-tile.has-video .vcall-remote-name{
    background:rgba(0,0,0,.55) !important;
  }
  .vcall-shell.group-mode.nona-primary-layout .vcall-host-tile{
    right:0 !important;
    bottom:-150px !important;
    width:min(18vw, 300px) !important;
    min-width:200px !important;
  ...
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-primary-count="9"]{
    grid-template-columns:repeat(10, minmax(0, 1fr)) !important;
    grid-template-rows:repeat(2, minmax(0, 1fr)) !important;
    grid-auto-rows:minmax(0, 1fr) !important;
    grid-auto-flow:row !important;
  ...
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-primary-count="9"] .vcall-primary-1{
    grid-column:1 / 3 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-primary-count="9"] .vcall-primary-2{
    grid-column:3 / 5 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-primary-count="9"] .vcall-primary-3{
    grid-column:5 / 7 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-primary-count="9"] .vcall-primary-4{
    grid-column:7 / 9 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-primary-count="9"] .vcall-primary-5{
    grid-column:9 / 11 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-primary-count="9"] .vcall-primary-6{
    grid-column:2 / 4 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-primary-count="9"] .vcall-primary-7{
    grid-column:4 / 6 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-primary-count="9"] .vcall-primary-8{
    grid-column:6 / 8 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-primary-count="9"] .vcall-primary-9{
    grid-column:8 / 10 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.deca-primary-layout .vcall-remote-grid{
  ...
  .vcall-shell.group-mode.deca-primary-layout .vcall-primary-tile{
    width:100% !important;
    max-width:none !important;
    height:100% !important;
    min-height:0 !important;
  ...
  .vcall-shell.group-mode.deca-primary-layout .vcall-primary-tile video,
  .vcall-shell.group-mode.deca-primary-layout .vcall-primary-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.deca-primary-layout .vcall-host-tile video,
  .vcall-shell.group-mode.deca-primary-layout .vcall-host-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.deca-primary-layout .vcall-local-tile .vcall-local{
    position:absolute !important;
    inset:0 !important;
    width:100% !important;
    max-width:none !important;
  ...
  .vcall-shell.group-mode.deca-primary-layout .vcall-remote-tile.has-video .vcall-remote-card{
    background:transparent !important;
    opacity:1 !important;
    pointer-events:none !important;
    justify-content:flex-end !important;
  ...
  .vcall-shell.group-mode.deca-primary-layout .vcall-remote-tile.has-video .vcall-remote-name{
    background:rgba(0,0,0,.55) !important;
  }
  .vcall-shell.group-mode.deca-primary-layout .vcall-host-tile{
    right:0 !important;
    bottom:-150px !important;
    width:min(18vw, 300px) !important;
    min-width:200px !important;
  ...
  .vcall-shell.group-mode.host-layout.deca-primary-layout .vcall-remote-grid[data-primary-count="10"]{
    grid-template-columns:repeat(5, minmax(0, 1fr)) !important;
    grid-template-rows:repeat(2, minmax(0, 1fr)) !important;
    grid-auto-rows:minmax(0, 1fr) !important;
    grid-auto-flow:row !important;
  ...
  .vcall-shell.group-mode.host-layout.deca-primary-layout .vcall-remote-grid[data-primary-count="10"] .vcall-primary-1{
    grid-column:1 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.deca-primary-layout .vcall-remote-grid[data-primary-count="10"] .vcall-primary-2{
    grid-column:2 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.deca-primary-layout .vcall-remote-grid[data-primary-count="10"] .vcall-primary-3{
    grid-column:3 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.deca-primary-layout .vcall-remote-grid[data-primary-count="10"] .vcall-primary-4{
    grid-column:4 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.deca-primary-layout .vcall-remote-grid[data-primary-count="10"] .vcall-primary-5{
    grid-column:5 !important;
    grid-row:1 !important;
  }
  .vcall-shell.group-mode.host-layout.deca-primary-layout .vcall-remote-grid[data-primary-count="10"] .vcall-primary-6{
    grid-column:1 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.host-layout.deca-primary-layout .vcall-remote-grid[data-primary-count="10"] .vcall-primary-7{
    grid-column:2 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.host-layout.deca-primary-layout .vcall-remote-grid[data-primary-count="10"] .vcall-primary-8{
    grid-column:3 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.host-layout.deca-primary-layout .vcall-remote-grid[data-primary-count="10"] .vcall-primary-9{
    grid-column:4 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.host-layout.deca-primary-layout .vcall-remote-grid[data-primary-count="10"] .vcall-primary-10{
    grid-column:5 !important;
    grid-row:2 !important;
  }
  .vcall-shell.group-mode.undeca-primary-layout .vcall-remote-grid{
    inset:0 0 64px 0 !important;
    display:grid !important;
  ...
  .vcall-shell.group-mode.undeca-primary-layout .vcall-primary-tile{
    width:100% !important;
    max-width:none !important;
    height:100% !important;
    min-height:0 !important;
  ...
  .vcall-shell.group-mode.undeca-primary-layout .vcall-primary-tile video,
  .vcall-shell.group-mode.undeca-primary-layout .vcall-primary-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.undeca-primary-layout .vcall-host-tile video,
  .vcall-shell.group-mode.undeca-primary-layout .vcall-host-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.undeca-primary-layout .vcall-local-tile .vcall-local{
    position:absolute !important;
    inset:0 !important;
    width:100% !important;
    max-width:none !important;
  ...
  .vcall-shell.group-mode.undeca-primary-layout .vcall-remote-tile.has-video .vcall-remote-card{
    background:transparent !important;
    opacity:1 !important;
    pointer-events:none !important;
    justify-content:flex-end !important;
  ...
  .vcall-shell.group-mode.undeca-primary-layout .vcall-remote-tile.has-video .vcall-remote-name{
    background:rgba(0,0,0,.55) !important;
  }
  .vcall-shell.group-mode.undeca-primary-layout .vcall-host-tile{
    right:0 !important;
    bottom:-150px !important;
    width:min(18vw, 300px) !important;
    min-width:200px !important;
  ...
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-primary-count="11"]{
    grid-template-columns:repeat(12, minmax(0, 1fr)) !important;
    grid-template-rows:repeat(2, minmax(0, 1fr)) !important;
    grid-auto-rows:minmax(0, 1fr) !important;
    grid-auto-flow:row !important;
  ...
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-primary-count="11"] .vcall-primary-1{grid-column:1 / 3 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-primary-count="11"] .vcall-primary-2{grid-column:3 / 5 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-primary-count="11"] .vcall-primary-3{grid-column:5 / 7 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-primary-count="11"] .vcall-primary-4{grid-column:7 / 9 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-primary-count="11"] .vcall-primary-5{grid-column:9 / 11 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-primary-count="11"] .vcall-primary-6{grid-column:11 / 13 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-primary-count="11"] .vcall-primary-7{grid-column:2 / 4 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-primary-count="11"] .vcall-primary-8{grid-column:4 / 6 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-primary-count="11"] .vcall-primary-9{grid-column:6 / 8 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-primary-count="11"] .vcall-primary-10{grid-column:8 / 10 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-primary-count="11"] .vcall-primary-11{grid-column:10 / 12 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.dodeca-primary-layout .vcall-remote-grid{
    inset:0 0 64px 0 !important;
    display:grid !important;
    grid-template-columns:repeat(12, minmax(0, 1fr)) !important;
    grid-template-rows:repeat(2, minmax(0, 1fr)) !important;
  ...
  .vcall-shell.group-mode.dodeca-primary-layout .vcall-primary-tile{
    width:100% !important;
    max-width:none !important;
    height:100% !important;
    min-height:0 !important;
  ...
  .vcall-shell.group-mode.dodeca-primary-layout .vcall-primary-tile video,
  .vcall-shell.group-mode.dodeca-primary-layout .vcall-primary-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.dodeca-primary-layout .vcall-host-tile video,
  .vcall-shell.group-mode.dodeca-primary-layout .vcall-host-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.dodeca-primary-layout .vcall-local-tile .vcall-local{
    position:absolute !important;
    inset:0 !important;
    width:100% !important;
    max-width:none !important;
  ...
  .vcall-shell.group-mode.dodeca-primary-layout .vcall-remote-tile.has-video .vcall-remote-card{
    background:transparent !important;
    opacity:1 !important;
    pointer-events:none !important;
    justify-content:flex-end !important;
  ...
  .vcall-shell.group-mode.dodeca-primary-layout .vcall-remote-tile.has-video .vcall-remote-name{
    background:rgba(0,0,0,.55) !important;
  }
  .vcall-shell.group-mode.dodeca-primary-layout .vcall-host-tile{
    right:0 !important;
    bottom:-150px !important;
    width:min(18vw, 300px) !important;
    min-width:200px !important;
  ...
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-primary-count="12"]{
    grid-template-columns:repeat(12, minmax(0, 1fr)) !important;
    grid-template-rows:repeat(2, minmax(0, 1fr)) !important;
    grid-auto-rows:minmax(0, 1fr) !important;
    grid-auto-flow:row !important;
  ...
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-primary-count="12"] .vcall-primary-1{grid-column:1 / 3 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-primary-count="12"] .vcall-primary-2{grid-column:3 / 5 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-primary-count="12"] .vcall-primary-3{grid-column:5 / 7 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-primary-count="12"] .vcall-primary-4{grid-column:7 / 9 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-primary-count="12"] .vcall-primary-5{grid-column:9 / 11 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-primary-count="12"] .vcall-primary-6{grid-column:11 / 13 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-primary-count="12"] .vcall-primary-7{grid-column:1 / 3 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-primary-count="12"] .vcall-primary-8{grid-column:3 / 5 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-primary-count="12"] .vcall-primary-9{grid-column:5 / 7 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-primary-count="12"] .vcall-primary-10{grid-column:7 / 9 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-primary-count="12"] .vcall-primary-11{grid-column:9 / 11 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-primary-count="12"] .vcall-primary-12{grid-column:11 / 13 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.trideca-primary-layout .vcall-remote-grid{
    inset:0 0 64px 0 !important;
    display:grid !important;
  ...
  .vcall-shell.group-mode.trideca-primary-layout .vcall-primary-tile{
    width:100% !important;
    max-width:none !important;
    height:100% !important;
    min-height:0 !important;
  ...
  .vcall-shell.group-mode.trideca-primary-layout .vcall-primary-tile video,
  .vcall-shell.group-mode.trideca-primary-layout .vcall-primary-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.trideca-primary-layout .vcall-host-tile video,
  .vcall-shell.group-mode.trideca-primary-layout .vcall-host-tile .vcall-remote-snapshot,
  .vcall-shell.group-mode.trideca-primary-layout .vcall-local-tile .vcall-local{
    position:absolute !important;
    inset:0 !important;
    width:100% !important;
    max-width:none !important;
  ...
  .vcall-shell.group-mode.trideca-primary-layout .vcall-remote-tile.has-video .vcall-remote-card{
    background:transparent !important;
    opacity:1 !important;
    pointer-events:none !important;
    justify-content:flex-end !important;
  ...
  .vcall-shell.group-mode.trideca-primary-layout .vcall-remote-tile.has-video .vcall-remote-name{
    background:rgba(0,0,0,.55) !important;
  }
  .vcall-shell.group-mode.trideca-primary-layout .vcall-host-tile{
    right:0 !important;
    bottom:-150px !important;
    width:min(18vw, 300px) !important;
    min-width:200px !important;
  ...
  .vcall-shell.group-mode.host-layout.trideca-primary-layout .vcall-remote-grid[data-primary-count="13"]{
    grid-template-columns:repeat(14, minmax(0, 1fr)) !important;
    grid-template-rows:repeat(2, minmax(0, 1fr)) !important;
    grid-auto-rows:minmax(0, 1fr) !important;
    grid-auto-flow:row !important;
  ...
  .vcall-shell.group-mode.host-layout.trideca-primary-layout .vcall-remote-grid[data-primary-count="13"] .vcall-primary-1{grid-column:1 / 3 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.trideca-primary-layout .vcall-remote-grid[data-primary-count="13"] .vcall-primary-2{grid-column:3 / 5 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.trideca-primary-layout .vcall-remote-grid[data-primary-count="13"] .vcall-primary-3{grid-column:5 / 7 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.trideca-primary-layout .vcall-remote-grid[data-primary-count="13"] .vcall-primary-4{grid-column:7 / 9 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.trideca-primary-layout .vcall-remote-grid[data-primary-count="13"] .vcall-primary-5{grid-column:9 / 11 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.trideca-primary-layout .vcall-remote-grid[data-primary-count="13"] .vcall-primary-6{grid-column:11 / 13 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.trideca-primary-layout .vcall-remote-grid[data-primary-count="13"] .vcall-primary-7{grid-column:13 / 15 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.trideca-primary-layout .vcall-remote-grid[data-primary-count="13"] .vcall-primary-8{grid-column:2 / 4 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.trideca-primary-layout .vcall-remote-grid[data-primary-count="13"] .vcall-primary-9{grid-column:4 / 6 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.trideca-primary-layout .vcall-remote-grid[data-primary-count="13"] .vcall-primary-10{grid-column:6 / 8 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.trideca-primary-layout .vcall-remote-grid[data-primary-count="13"] .vcall-primary-11{grid-column:8 / 10 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.trideca-primary-layout .vcall-remote-grid[data-primary-count="13"] .vcall-primary-12{grid-column:10 / 12 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.trideca-primary-layout .vcall-remote-grid[data-primary-count="13"] .vcall-primary-13{grid-column:12 / 14 !important;grid-row:2 !important;}
  .vcall-local{
    position:absolute;
  ...
  .vcall-controls{
    ...
    padding:10px 18px;
    border-radius:999px;
    background:var(--msb-palette-hover-bg, rgba(9,15,24,.9));
    border:1px solid var(--msb-palette-border, rgba(255,255,255,.08));
  ...
  .vcall-end-btn{
    ...
    font-size:18px;
    color:var(--msb-palette-text, #fff);
    background:var(--msb-palette-hover-bg, #111d31);
  ...
  @media (max-width: 991.98px){
    ...
    .vcall-shell.whereby-ui .vcall-header,
    .vcall-shell.group-mode .vcall-header{
      inset:14px 14px auto 14px;
    }
    .vcall-brand-mark{font-size:26px;}
    .vcall-meta-pill{
      min-height:42px;
      padding:0 12px;
      gap:10px;
    }
    .vcall-shell.whereby-ui .vcall-stage-wrap,
    .vcall-shell.group-mode .vcall-stage-wrap{
      padding:0 18px;
    }
    ...
    .vcall-shell.group-mode.pinned-host-layout .vcall-host-tile,
    .vcall-shell.group-mode.host-layout .vcall-host-tile{
    ...
    .vcall-shell.group-mode.pinned-host-layout .vcall-remote-grid[data-guest-count="2"]{
      gap:12px;
    }
    .vcall-stage-local-label{
      right:22px;
    ...
    .vcall-shell.whereby-ui .vcall-controls,
    .vcall-shell.group-mode .vcall-controls{
      gap:12px;
      bottom:18px;
      padding:0;
    ...
    .vcall-shell.whereby-ui .vcall-icon-btn,
    .vcall-shell.whereby-ui .vcall-end-btn,
    .vcall-shell.group-mode .vcall-icon-btn,
    .vcall-shell.group-mode .vcall-end-btn{
      width:52px;
      height:52px;
    ...
    .vcall-shell.whereby-ui .vcall-control-item span,
    .vcall-shell.group-mode .vcall-control-item span{
      font-size:12px;
    }
    .gif-picker{
  ...
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-tile-count="10"][data-primary-count="9"]{
    inset:0 0 112px 0 !important;
    display:grid !important;
    grid-template-columns:repeat(10, minmax(0, 1fr)) !important;
    grid-template-rows:repeat(2, minmax(0, 1fr)) !important;
  ...
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-tile-count="10"][data-primary-count="9"] .vcall-primary-tile{
    width:100% !important;
    max-width:none !important;
    height:100% !important;
    min-height:0 !important;
  ...
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-tile-count="10"][data-primary-count="9"] .vcall-primary-1{grid-column:1 / 3 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-tile-count="10"][data-primary-count="9"] .vcall-primary-2{grid-column:3 / 5 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-tile-count="10"][data-primary-count="9"] .vcall-primary-3{grid-column:5 / 7 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-tile-count="10"][data-primary-count="9"] .vcall-primary-4{grid-column:7 / 9 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-tile-count="10"][data-primary-count="9"] .vcall-primary-5{grid-column:9 / 11 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-tile-count="10"][data-primary-count="9"] .vcall-primary-6{grid-column:2 / 4 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-tile-count="10"][data-primary-count="9"] .vcall-primary-7{grid-column:4 / 6 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-tile-count="10"][data-primary-count="9"] .vcall-primary-8{grid-column:6 / 8 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.nona-primary-layout .vcall-remote-grid[data-tile-count="10"][data-primary-count="9"] .vcall-primary-9{grid-column:8 / 10 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-tile-count="12"][data-primary-count="11"]{
    inset:0 0 64px 0 !important;
    display:grid !important;
    grid-template-columns:repeat(12, minmax(0, 1fr)) !important;
    grid-template-rows:repeat(2, minmax(0, 1fr)) !important;
  ...
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-tile-count="12"][data-primary-count="11"] .vcall-primary-tile{
    width:100% !important;
    max-width:none !important;
    height:100% !important;
    min-height:0 !important;
  ...
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-tile-count="12"][data-primary-count="11"] .vcall-primary-1{grid-column:1 / 3 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-tile-count="12"][data-primary-count="11"] .vcall-primary-2{grid-column:3 / 5 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-tile-count="12"][data-primary-count="11"] .vcall-primary-3{grid-column:5 / 7 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-tile-count="12"][data-primary-count="11"] .vcall-primary-4{grid-column:7 / 9 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-tile-count="12"][data-primary-count="11"] .vcall-primary-5{grid-column:9 / 11 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-tile-count="12"][data-primary-count="11"] .vcall-primary-6{grid-column:11 / 13 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-tile-count="12"][data-primary-count="11"] .vcall-primary-7{grid-column:2 / 4 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-tile-count="12"][data-primary-count="11"] .vcall-primary-8{grid-column:4 / 6 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-tile-count="12"][data-primary-count="11"] .vcall-primary-9{grid-column:6 / 8 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-tile-count="12"][data-primary-count="11"] .vcall-primary-10{grid-column:8 / 10 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.undeca-primary-layout .vcall-remote-grid[data-tile-count="12"][data-primary-count="11"] .vcall-primary-11{grid-column:10 / 12 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-tile-count="13"][data-primary-count="12"]{
    inset:0 0 64px 0 !important;
    display:grid !important;
    grid-template-columns:repeat(12, minmax(0, 1fr)) !important;
    grid-template-rows:repeat(2, minmax(0, 1fr)) !important;
  ...
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-tile-count="13"][data-primary-count="12"] .vcall-primary-tile{
    width:100% !important;
    max-width:none !important;
    height:100% !important;
    min-height:0 !important;
  ...
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-tile-count="13"][data-primary-count="12"] .vcall-primary-1{grid-column:1 / 3 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-tile-count="13"][data-primary-count="12"] .vcall-primary-2{grid-column:3 / 5 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-tile-count="13"][data-primary-count="12"] .vcall-primary-3{grid-column:5 / 7 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-tile-count="13"][data-primary-count="12"] .vcall-primary-4{grid-column:7 / 9 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-tile-count="13"][data-primary-count="12"] .vcall-primary-5{grid-column:9 / 11 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-tile-count="13"][data-primary-count="12"] .vcall-primary-6{grid-column:11 / 13 !important;grid-row:1 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-tile-count="13"][data-primary-count="12"] .vcall-primary-7{grid-column:1 / 3 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-tile-count="13"][data-primary-count="12"] .vcall-primary-8{grid-column:3 / 5 !important;grid-row:2 !important;}
  .vcall-shell.group-mode.host-layout.dodeca-primary-layout .vcall-remote-grid[data-tile-count="13"][data-primary-count="12"] .vcall-primary-9{grid-column:5 / 7 !important;grid-row:2 !important;}
                ...
                <div id="chatStream">
                  <?php if (!empty($groupMessages)): ?>
                    ...
                    <?php
                        ...
                        $groupBodyText = call_event_display_text((string)($groupReplyBits['text'] ?? ''), $groupIsMe, true);
              ...
              <?php if (!empty($groupMessages)): ?>
                <?php foreach ($groupMessages as $sidebarGroupMessage): ?>
                  <?php
                    ...
                    $sidebarBodyText = trim(call_event_display_text((string)($sidebarReplyBits['text'] ?? ''), $sidebarIsMe, true));
                    if ($sidebarBodyText === '') {
                      $sidebarBodyText = trim(call_event_display_text((string)($sidebarGroupMessage['body'] ?? ''), $sidebarIsMe, true));
                    }
                  ?>
...
(function(){
  ...
  function updateGroupHostLayout(){
    ...
    const allTiles = Array.from(vcallRemoteGrid.querySelectorAll('.vcall-remote-tile'));
    const tiles = allTiles.slice(0, 14);
    const tileCount = Math.min(14, allTiles.length);
    const hostUserId = Number(callState.startedByUserId || currentUserId || 0);
    let hostTile = null;
    const localTile = tiles.find(function(tile){ return tile.classList.contains('vcall-local-tile'); }) || null;

    allTiles.forEach(function(tile, index){
      tile.style.display = index < 14 ? '' : 'none';
      tile.classList.remove('vcall-host-tile', 'vcall-primary-tile', 'vcall-primary-1', 'vcall-primary-2', 'vcall-primary-3', 'vcall-primary-4', 'vcall-primary-5', 'vcall-primary-6', 'vcall-primary-7', 'vcall-primary-8', 'vcall-primary-9', 'vcall-primary-10', 'vcall-primary-11', 'vcall-primary-12', 'vcall-primary-13');
      const tileUserId = Number(tile.getAttribute('data-user-id') || 0);
      if(index < 14 && !localTile && !hostTile && hostUserId > 0 && tileUserId === hostUserId){
        hostTile = tile;
      }
    });
    ...
    primaryTiles.slice(0, 13).forEach(function(tile, index){
    ...
    if(primaryTiles.length > 0){
      vcallRemoteGrid.setAttribute('data-primary-count', String(Math.min(13, primaryTiles.length)));
    } else {
    ...
    const usePinnedHostLayout = useHostLayout && !!hostTile && primaryTiles.length >= 1 && primaryTiles.length <= 13;
    const useSoloPrimaryLayout = usePinnedHostLayout && primaryTiles.length === 1;
    const useSplitPrimaryLayout = usePinnedHostLayout && primaryTiles.length === 2;
    const useTriplePrimaryLayout = usePinnedHostLayout && primaryTiles.length === 3;
    const useQuadPrimaryLayout = usePinnedHostLayout && primaryTiles.length === 4;
    const useQuintPrimaryLayout = usePinnedHostLayout && primaryTiles.length === 5;
    const useSextPrimaryLayout = usePinnedHostLayout && primaryTiles.length === 6;
    const useSeptPrimaryLayout = usePinnedHostLayout && primaryTiles.length === 7;
    const useOctPrimaryLayout = usePinnedHostLayout && primaryTiles.length === 8;
    const useNonaPrimaryLayout = usePinnedHostLayout && primaryTiles.length === 9;
    const useDecaPrimaryLayout = usePinnedHostLayout && primaryTiles.length === 10;
    const useUndecaPrimaryLayout = usePinnedHostLayout && primaryTiles.length === 11;
    const useDodecaPrimaryLayout = usePinnedHostLayout && primaryTiles.length === 12;
    const useTridecaPrimaryLayout = usePinnedHostLayout && primaryTiles.length === 13;
    vcallShell.classList.toggle('host-layout', useHostLayout);
    vcallShell.classList.toggle('pinned-host-layout', usePinnedHostLayout);
    vcallShell.classList.toggle('solo-primary-layout', useSoloPrimaryLayout);
    vcallShell.classList.toggle('split-primary-layout', useSplitPrimaryLayout);
    vcallShell.classList.toggle('triple-primary-layout', useTriplePrimaryLayout);
    vcallShell.classList.toggle('quad-primary-layout', useQuadPrimaryLayout);
    vcallShell.classList.toggle('quint-primary-layout', useQuintPrimaryLayout);
    vcallShell.classList.toggle('sext-primary-layout', useSextPrimaryLayout);
    vcallShell.classList.toggle('sept-primary-layout', useSeptPrimaryLayout);
    vcallShell.classList.toggle('oct-primary-layout', useOctPrimaryLayout);
    vcallShell.classList.toggle('nona-primary-layout', useNonaPrimaryLayout);
    vcallShell.classList.toggle('deca-primary-layout', useDecaPrimaryLayout);
    vcallShell.classList.toggle('undeca-primary-layout', useUndecaPrimaryLayout);
    vcallShell.classList.toggle('dodeca-primary-layout', useDodecaPrimaryLayout);
    vcallShell.classList.toggle('trideca-primary-layout', useTridecaPrimaryLayout);
  ...
  function ensureLocalGroupTile(){
    ...
    if(!vcallLocalTile){
      ...
      card.innerHTML =
        ...
        '<div class="vcall-remote-name">' + esc(meDisplay || 'You') + '</div>' +
    ...
    if(callState.localStream && vcallLocalVideo){
      if(vcallLocalVideo.srcObject !== callState.localStream){
        vcallLocalVideo.srcObject = callState.localStream;
      }
      try{
  ...
  function messageDisplayText(item, isMe, isGroup){
    if(Number(item.deleted_for_all || 0) === 1){
      return isMe ? 'You unsent a message.' : 'This message was unsent.';
    }
    const callEventText = callEventDisplayText(item.text || '', isMe, !!isGroup);
  ...
  function callEventDisplayText(text, isMe, isGroup){
  ...
  function appendVideoCallChatItem(item){
    ...
    const isMe = !!item.is_me;
    const displayText = String(messageDisplayText(item, isMe, callState.scope === 'group' || !!selectedGroupId) || '').trim();
  ...
  function appendGroupChatMessageItem(item){
    ...
    const senderFriendCode = String(item.friend_code || '');
    const rawText = normalizeMessageTextForAttachment(item.text || '', item.attachment_url || '');
    const text = messageDisplayText({ text: rawText, deleted_for_all: item.deleted_for_all || 0 }, isMe, true);
  ...
  function groupRoomCountLabel(){
    const tileCount = vcallRemoteGrid ? Math.min(14, vcallRemoteGrid.querySelectorAll('.vcall-remote-tile').length) : 0;
  ...
  function hideVideoOverlay(){
    ...
    if(vcallShell) vcallShell.classList.remove('host-layout', 'pinned-host-layout', 'solo-primary-layout', 'split-primary-layout', 'triple-primary-layout', 'quad-primary-layout', 'quint-primary-layout', 'sext-primary-layout', 'sept-primary-layout', 'oct-primary-layout', 'nona-primary-layout', 'deca-primary-layout', 'undeca-primary-layout', 'dodeca-primary-layout', 'trideca-primary-layout');
  }
