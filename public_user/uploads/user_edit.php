...
<head>
  ...
  <style>
    ...
    .about-people-role,.about-people-mention{
      height:42px;border-radius:8px;border:1px solid #343d4e;background:#121826;color:#f4f6fb;
    ...
    .about-people-ac{
      ...
      background:#121826;border:1px solid #343d4e;border-radius:10px;
    ...
    .about-people-chips li{
      ...
      padding:8px 10px;border-radius:8px;background:#121826;border:1px solid #2a3344;
