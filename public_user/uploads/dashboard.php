                ...
                <form id="createPostForm" action="post_save.php" method="post" enctype="multipart/form-data" data-modal="<?= $isModalCreate ? '1' : '0' ?>" onsubmit="return false;">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <select name="visibility" id="createPostVisibility" class="form-control">
                        ...
                        <option value="friends" <?= $vis==='friends'?'selected':'' ?>><?= $isPublisherAccount ? 'Friends room (Circle)' : 'Friends' ?></option>
                      ...
                      <?php elseif ($isPublisherAccount): ?>
                        <small class="text-muted"><strong>Private</strong> → only you. <strong>Friends</strong> → post card on Circle (feed.php). <strong>Public</strong> → Discover (public.php).</small>
                      <?php else: ?>
