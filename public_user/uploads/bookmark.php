...
<div class="ig-bookmark">
  <header class="ig-bookmark-top">
    ...
    <div class="ig-bookmark-stories-block">
      <div class="ig-bookmark-stories-label">Moments</div>
  ...
  <div class="ig-bookmark-body">
    <?php if ($feedPosts): ?>
      <section class="ig-bookmark-section" aria-label="Bookmarked posts">
        <div class="ig-bookmark-posts-meta">
          ...
          <p class="ig-bookmark-note" style="margin-top:0;margin-bottom:12px;">Saved from Circle, Discover, Clips, or Profile post menus.</p>
        </div>
    ...
    <?php elseif (!$hasStories): ?>
      <div class="ig-bookmark-empty" role="status">
        ...
        <p>Use Bookmark on a post card or story menu in Circle, Discover, Clips, or Profile. Find them again here under Settings.</p>
      </div>
    <?php else: ?>
      <div class="ig-bookmark-empty" role="status">
