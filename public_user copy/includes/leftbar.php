...
(function(){
  ...
  document.addEventListener('click', function(e){
    ...
    if(target.closest('.ig-stories-menu-btn, .ig-story-item, .js-open-comments, .js-open-readmore, .js-open-profile-door, .js-open-messages-door, .js-open-notifications-door, .js-open-friend-requests-door, .feed-ig-avatar')) return;
    if(target.closest('#tt-stories-wrap, #ttStoriesClose')) return;
