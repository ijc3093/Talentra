...
<?php if (!$__isFeedPage): ?><div class="sh-sideleft-menu"><?php endif; ?>
  <label class="sh-sidebar-label">Navigation</label>
  <ul class="nav">
    <li class="nav-item">
      <a href="feed.php" class="nav-link<?= $__isActive('feed.php') ?>">
...
<?php if (!$__isFeedPage): ?></div><?php endif; ?>
