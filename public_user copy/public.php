...
foreach ($posts as $postIndex => &$post) {
    ...
    if ($liveId > 0) {
        $liveMeta = public_fetch_live_meta($dbh, $liveId);
        if ($liveMeta === null) {
...
(function(){
  ...
  $(document).on('click', function(e){
    ...
    if(target.closest('#tt-menu-wrap, #tt-comments-wrap, #tt-readmore-wrap, #tt-profile-wrap, #tt-stories-wrap, #ttMenuClose, #ttCommentsClose, #ttRmClose, #ttProfileClose, #ttStoriesClose, .tt-story-cmt-sheet, .tt-story-cmt-panel, .tt-story-cmt-backdrop')) return;
    if(target.closest('.ig-stories-menu-btn, .ig-story-item, .ig-story-empty, .js-open-comments, .js-open-readmore, .js-open-profile-door, .js-open-messages-door, .js-open-notifications-door, .js-open-friend-requests-door, .feed-ig-avatar')) return;
