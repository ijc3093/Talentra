(function(){
  ...
  function paletteMeta(slug){
    ...
    if (slug === 'dark') return { hex: '#24292d', dark: true };
  ...
  var PALETTE_PAINT_SELECTORS = [
    ...
    '.public-publisher-search', '.feed-left-nav', '.ttNavLeftbar', '.sh-pagetitle-left',
    '.mf-feed', '.mf-card', '.mf-head', '.mf-foot', '.mf-actions', '.mf-menu',
  ...
  var PALETTE_FEED_SURFACE_SELECTORS = [
    ...
    'body .mf-feed .mf-card', 'body .mf-feed .mf-card .mf-head', 'body .mf-feed .mf-card .mf-foot',
    'body .mf-feed .mf-card .mf-actions', 'body .mf-feed .mf-card .mf-title', 'body .mf-feed .mf-card .mf-body',
    '.mf-card .mf-head', '.mf-card .mf-foot', '.mf-card .mf-actions', '.mf-card .mf-title', '.mf-card .mf-body',
  ...
  function ensurePalettePaintStyle(){
    ...
    style.textContent =
      ...
      '}\n' +
      'html[data-msb-appearance] a:not(.btn-primary):not(.bg-primary):not(.messages-shell-tab.active) {\n' +
      '  color: var(--msb-palette-link) !important;\n' +
      '}\n' +
  ...
  function clearPaletteVars(root){
    var props = [
      ...
      '--feed-accent', '--feed-accent-soft', '--feed-accent-strong', '--blue'
    ];
  ...
  function applyPaletteVars(root, slug){
    ...
    var sidebar = bg;
    var headerBg = bg;
    var fg = paletteForegroundColors(bg, isDark);
