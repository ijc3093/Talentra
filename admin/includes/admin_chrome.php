...
if (!function_exists('admin_chrome_logo')) {
    ...
    <div class="sh-logopanel">
      <a href="dashboard.php" class="sh-logo-text azia-brand" title="Talentra">Talentra</a>
    </div>
        <?php
    }
}
...
if (!function_exists('admin_chrome_header')) {
    function admin_chrome_header(?string $pageLabel = null): void
    {
        static $done = false;
        if ($done) {
            return;
        ...
        ?>
    <div class="sh-headpanel azia-headpanel">
...
if (!function_exists('admin_chrome_open')) {
     ...
     */
    function admin_chrome_open(?string $pageLabel = null): void
    {
        admin_chrome_logo();
